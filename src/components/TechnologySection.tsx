...
const TechnologySection = () => {
  const features = ["Monitoramento em tempo real 24/7 do seu sistema solar.", "Relatórios detalhados de geração de energia e economia.", "Painéis solares e componentes de alta durabilidade e performance.", "Equipe de engenharia Solo Energia altamente qualificada."];
  ...
  return <section className="py-16 md:py-24 bg-solo-dark-gray text-white">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <div className="text-center mb-12">
          <img src="https://i.imgur.com/Zu5CF8a.png" alt="Tecnologia Solo Energia - Painéis Solares e Monitoramento" className="h-12 mx-auto mb-4 opacity-70" onError={e => {
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <img alt="Dashboard de Monitoramento de Energia Solar Solo Energia" className="rounded-xl shadow-2xl w-full h-auto object-cover" onError={e => {
