...
const Header = () => {
  ...
  return (
    <header className="w-full z-40 absolute top-0 left-0 right-0">
      <div className="container mx-auto px-6 sm:px-10 py-3 flex justify-between items-center max-w-7xl">
        <div>
          <img 
        ...
        <nav className="hidden md:flex space-x-5 lg:space-x-6 items-center">
          <button 
            ...
            className="nav-link py-2 font-semibold text-sm lg:text-base text-white"
          >
            Como Funciona
          </button>
          <button 
          ...
          <button 
            ...
            className="btn-primary-gradient py-2 px-5 lg:px-6 rounded-lg transition duration-300 transform hover:scale-105 text-sm lg:text-base"
          >
            Fale Conosco
          </button>
        </nav>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-solo-black bg-opacity-95 py-3 absolute top-full left-0 right-0 shadow-lg">
          <button 
            onClick={() => scrollToSection('jornada')}
            className="block w-full text-center py-2 text-white hover:bg-solo-dark-gray transition duration-300"
          >
          ...
          <button 
            onClick={() => scrollToSection('contato')}
            className="block w-full text-center py-3 text-solo-yellow font-semibold hover:opacity-90 transition duration-300"
          >
            Fale Conosco
          </button>
        </div>
