...
const JourneySection = () => {
  ...
  return <section id="jornada" className="py-16 md:py-24 bg-solo-light-gray">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <h2 className="text-3xl font-bold text-center mb-4 text-solo-black md:text-3xl">
        ...
        <div className="hidden md:flex flex-wrap justify-center items-stretch gap-6 lg:gap-8">
          ...
          return <div key={index} className="journey-item text-center flex flex-col items-center p-4 bg-white rounded-xl shadow-md w-full sm:w-[45%] lg:w-[18%] min-h-[280px]">
        ...
        <div className="md:hidden space-y-10">
          {journeySteps.map((step, index) => {
          const IconComponent = step.icon;
          return <div key={index} className="journey-item text-center flex flex-col items-center">
