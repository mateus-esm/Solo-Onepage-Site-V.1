...
const HeroSection = () => {
  ...
  return <section className="bg-hero-bg bg-cover bg-center min-h-screen flex flex-col text-white">
      <Header />
      
      <div className="flex-grow flex items-center justify-center my-0">
        <div className="container mx-auto px-4 sm:px-6 text-center py-10 md:py-16 max-w-7xl">
          <h1 className="text-4xl sm:text-5xl font-extrabold mb-10 leading-tight drop-shadow-2xl lg:text-6xl">
